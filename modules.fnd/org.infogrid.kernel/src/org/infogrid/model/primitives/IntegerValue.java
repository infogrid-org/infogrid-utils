            ...
            PropertyValue
{
    ...
    public int hashCode()
    {
        ...
        int hash = 7;
        hash = 41 * hash + (int) (this.theValue ^ (this.theValue >>> 32));
        hash = 41 * hash + (this.theUnit != null ? this.theUnit.hashCode() : 0);
        return hash;
    }
    ...
    public String toStringRepresentation(
            ...
            boolean                     colloquial )
    {
        return rep.formatEntry( getClass(), DEFAULT_ENTRY, maxLength, colloquial, theValue, theUnit );
    }
