            ...
            AbstractHadoopStoreTest
{
            ...
            String [] args )
    {
        ...
        try {
            ...
            test = new HadoopStoreTest2( args );
            test.run();
     ...
     */
    public HadoopStoreTest2(
            String [] args )
        throws
            Exception
    {
        super( HadoopStoreTest2.class  );
    ...
    // Our Logger
    private static Log log = Log.getLogInstance( HadoopStoreTest2.class);
