 ...
 */
public class HadoopStoreTest1
        extends
            AbstractHadoopStoreTest
{
    /**
     * Run the test.
     *
            ...
            String [] args )
    {
        ...
        try {
            ...
            test = new HadoopStoreTest1( args );
            test.run();
     ...
     */
    public HadoopStoreTest1(
            String [] args )
        throws
            Exception
    {
        super( HadoopStoreTest1.class  );
        
        theTestStore = theHadoopStore;
    }
    ...
    // Our Logger
    private static Log log = Log.getLogInstance( HadoopStoreTest1.class);
    ...
    static {
        ...
        try {
            data = StreamUtils.slurp( HadoopStoreTest1.class.getResourceAsStream( "TestImage.jpg" ));
        } catch( IOException ex ) {
            log.error( ex );
        }
        testImage = data;
