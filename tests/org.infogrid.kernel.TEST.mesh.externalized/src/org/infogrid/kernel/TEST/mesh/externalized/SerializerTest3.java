            ...
            AbstractSerializerTest
{
    ...
    /**
      ...
      * @param args command-line arguments
      */
    public SerializerTest3(
            String [] args )
        throws
            Exception
    {
        super( SerializerTest3.class );
    }

    // Our Logger
    private static Log log = Log.getLogInstance( SerializerTest3.class );
