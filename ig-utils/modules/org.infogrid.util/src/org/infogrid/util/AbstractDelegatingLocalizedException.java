        ...
        AbstractLocalizedException
{
            ...
            StringifierException
    {
        Throwable cause = getCause();
        if( cause instanceof LocalizedException ) {
            return ((LocalizedException)cause).toStringRepresentationLinkStart( additionalArguments, target, title, rep, pars );
        } else {
            return super.toStringRepresentationLinkStart( additionalArguments, target, title, rep, pars );
        }
    }
