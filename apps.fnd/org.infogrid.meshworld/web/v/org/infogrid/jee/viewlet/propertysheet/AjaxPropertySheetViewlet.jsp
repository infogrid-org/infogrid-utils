<%@    page contentType="text/html"
 ...
 %>
<tmpl:stylesheet href="${CONTEXT}/v/org/infogrid/jee/viewlet/propertysheet/AjaxPropertySheetViewlet.css"/>
...
<v:viewlet>
 <table class="audit"> <!-- IE is unable to render float:right correctly, so here is a table for you -->
  <tr>
   ...
   <td class="audit">
 <%@ include file="/v/org/infogrid/jee/viewlet/propertysheet/AjaxPropertySheetViewlet/audit.jsp" %>
   </td>
  </tr>
 </table>

<%@ include file="/v/org/infogrid/jee/viewlet/propertysheet/AjaxPropertySheetViewlet/attributes.jsp" %>
<%@ include file="/v/org/infogrid/jee/viewlet/propertysheet/AjaxPropertySheetViewlet/neighbors.jsp" %>
