 <table class="attributes">
  <thead>
   <tr>
    <th class="type">
     <div class="slide-in-button"><a href="javascript:overlay_show( 'org-infogrid-jee-shell-http-HttpShellVerb-bless', { 'mesh.subject' : '<mesh:meshObjectId meshObjectName="Subject" stringRepresentation="Plain" filter="true" />' } )" title="Bless this MeshObject"><img src="${CONTEXT}/s/icons/add.png" alt="Add type"/></a></div>
     Type
    </th>
    <th>Property</th>
    <th>Value</th>
