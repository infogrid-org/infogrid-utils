 <table class="neighbors">
  <thead>
   <tr>
    ...
    <th class="neighbor">
     <div class="slide-in-button"><a href="javascript:overlay_show( 'org-infogrid-jee-shell-http-HttpShellVerb-relate', { 'mesh.subject' : '<mesh:meshObjectId meshObjectName="Subject" stringRepresentation="Plain" filter="true" />' } )" title="Add a neighbor"><img src="${CONTEXT}/s/images/add.png" alt="Add neighbor"/></a></div>
     Neighbor
    </th>
   </tr>
  </thead>
