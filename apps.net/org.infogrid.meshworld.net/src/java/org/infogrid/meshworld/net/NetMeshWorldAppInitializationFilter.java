            ...
            Filter
{
    ...
    public void doFilter(
        ...
        throws
            ...
            ServletException
    {
        synchronized( NetMeshWorldAppInitializationFilter.class ) {
            if( !isInitialized ) {
            ...
            ServletException
    {
        ...
        try {
            ...
            IterableStore proxyStore       = MysqlStore.create( theDataSource, theResourceHelper.getResourceStringOrDefault( "ProxyStoreTable",  "Proxies"       ));
            IterableStore shadowStore      = MysqlStore.create( theDataSource, theResourceHelper.getResourceStringOrDefault( "ShadowTable",      "Shadows"       ));
            IterableStore shadowProxyStore = MysqlStore.create( theDataSource, theResourceHelper.getResourceStringOrDefault( "ShadowProxyTable", "ShadowProxies" ));
