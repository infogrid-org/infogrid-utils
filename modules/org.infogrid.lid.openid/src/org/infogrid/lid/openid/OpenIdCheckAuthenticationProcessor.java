...
/**
 * Knows how to process incoming OpenID check immediate requests.
 */
public class OpenIdCheckAuthenticationProcessor
        extends
            AbstractLidService
        implements
            LidService
{
     ...
     * @return the created OpenIdCheckAuthenticationProcessor
     */
    public static OpenIdCheckAuthenticationProcessor create(
            Context c )
    {
        OpenIdCheckAuthenticationProcessor ret = new OpenIdCheckAuthenticationProcessor( c );
        return ret;
    }
     ...
     * @param c the context in which this <code>ObjectInContext</code> runs.
     */
    protected OpenIdCheckAuthenticationProcessor(
            Context c )
    {
