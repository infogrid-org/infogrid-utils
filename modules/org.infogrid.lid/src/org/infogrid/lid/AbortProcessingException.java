 ...
 */
public abstract class AbortProcessingException
        extends
            Exception
{
    /**
     ...
     * @param returnCode the HTTP return code to send back to the client
     * @param message the internally logged error message
     * @param cause the cause of the Exception, if any
     */
    protected AbortProcessingException(
            LidService         source,
            ...
            Throwable          cause )
    {
        ...
        theRequest      = lidRequest;
        theResponse     = lidResponse;        
    ...
    protected void writeResponseHeader(
        ...
        throws
            ...
            ServletException
    {
        response.setStatus( theReturnCode );
