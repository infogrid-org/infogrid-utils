            ...
            Transaction
{
    ...
    protected static class DirtyRecord
    {
        ...
        public int hashCode()
        {
            ...
            int hash = 7;
            hash = 29 * hash + (this.theDirtyMeshObject != null ? this.theDirtyMeshObject.hashCode() : 0);
            hash = 29 * hash + (this.theProjectionWatcher != null ? this.theProjectionWatcher.hashCode() : 0);
            hash = 29 * hash + (this.theEvent != null ? this.theEvent.hashCode() : 0);
            return hash;
        }
