        ...
        AbstractInfoGridBodyTag
{
            ...
            IgnoreException
    {
        ...
        String text = theFormatter.formatMeshObjectLinkStart( pageContext, obj, theRootPath, theStringRepresentation );
        print( text );
            ...
            IgnoreException
    {
        ...
        String text = theFormatter.formatMeshObjectLinkEnd( pageContext, obj, theRootPath, theStringRepresentation );
        print( text );
