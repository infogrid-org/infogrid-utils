        ...
        AbstractInfoGridBodyTag
{
            ...
            IgnoreException
    {
        ...
        String text = theFormatter.formatMeshBaseLinkStart( pageContext, mb, theRootPath, theStringRepresentation );
        print( text );
            ...
            IgnoreException
    {
        ...
        String text = theFormatter.formatMeshBaseLinkEnd( pageContext, mb, theRootPath, theStringRepresentation );
        print( text );
