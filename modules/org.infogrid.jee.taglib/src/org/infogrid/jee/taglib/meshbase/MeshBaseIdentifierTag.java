        ...
        AbstractInfoGridBodyTag
{
            ...
            IgnoreException
    {
        ...
        String text = theFormatter.formatMeshBaseIdentifierStart( pageContext, mb, theStringRepresentation );
            ...
            IgnoreException
    {
        ...
        String text = theFormatter.formatMeshBaseIdentifierEnd( pageContext, mb, theStringRepresentation );
               text = theFormatter.potentiallyShorten( text, theMaxLength );
