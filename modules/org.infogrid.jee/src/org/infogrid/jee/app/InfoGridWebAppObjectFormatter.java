 ...
 */
public class InfoGridWebAppObjectFormatter
        implements
            LocalizedObjectFormatter
{
     ...
     */
    public InfoGridWebAppObjectFormatter(
            String rootPath )
    {
     ...
     * Our ResourceHelper.
     */
    private static final ResourceHelper theResourceHelper = ResourceHelper.getInstance( InfoGridWebAppObjectFormatter.class );
}
