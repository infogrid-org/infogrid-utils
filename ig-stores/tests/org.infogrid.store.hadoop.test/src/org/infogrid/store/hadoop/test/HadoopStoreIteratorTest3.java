...
/**
 * Tests the HadoopStoreIterator.
 */
public class HadoopStoreIteratorTest3
        extends
            AbstractStoreIteratorTest3
{
    ...
    public static void main(
            String [] args )
    {
        HadoopStoreIteratorTest3 test = null;
        try {
            ...
            test = new HadoopStoreIteratorTest3( args );
            test.run();
     ...
     */
    public HadoopStoreIteratorTest3(
            String [] args )
        throws
            Exception
    {
        super( localFileName( HadoopStoreIteratorTest1.class, "/ResourceHelper" ));
    ...
    // Our Logger
    private static Log log = Log.getLogInstance( HadoopStoreIteratorTest1.class);
}
