            ...
            CanBeDumped
{
    ...
    /**
     * This is a special type of ProbeException that only applies to HTTP connections:
     * it indicates that a HTTP redirect was returned.
     */
    public static class HttpRedirectResponse
            extends
                ProbeException
    {
        private static final long serialVersionUID = 1L; // helps with serialization
        ...
        /**
         * Obtain the HTTP Location header that we got back.
         *
         * @return the HTTP Location header that we got back
         */
        ...
        public Object [] getLocalizationParameters()
        {
            return new Object[] { theNetworkIdentifier.getCanonicalForm(), getStatusCode(), getLocation() };
        }
