  ...
  <div class="org-infogrid-jee-viewlet-graphtree-GraphTreeViewlet-sidebar">
   <dl class="level1">
    <tree:treeIterate startObjectName="Subject" traversalSpecification="* *" levelVar="level" meshObjectLoopVar="current">
     ...
     <tree:nodeBefore>
      <dt><mesh:meshObjectLink meshObjectName="current" addArguments="lid-appcontext=iframe" target="detail"><mesh:meshObject meshObjectName="current" maxLength="20" /></mesh:meshObjectLink></dt>
     </tree:nodeBefore>
    </tree:treeIterate>
   </dl>
  </div>
